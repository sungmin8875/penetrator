...
file "et_jig_capacity_risk_analysis.py" from ../Python Script Allocation Engine/. The ONLY change is the
...
compute() in-memory via the wrapper in run_simulation.py (compute_et_jig_risk).
"""
"""
