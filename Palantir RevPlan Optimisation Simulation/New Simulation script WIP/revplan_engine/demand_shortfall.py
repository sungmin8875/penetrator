...
file "demand_shortfall_analysis.py" from ../Python Script Allocation Engine/. The ONLY change is the
...
compute() in-memory via the wrapper in run_simulation.py (compute_demand_shortfall) — its
equipment_shortages / lot_waiting_periods inputs are the capacity_shortage.py outputs (ported 2026-07-16),
and monthly_fulfillment consumes this module's output for the impossible_to_simulate category.
"""
"""
